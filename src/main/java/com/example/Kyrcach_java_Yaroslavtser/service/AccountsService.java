...
public interface AccountsService {
  ...
  //  List<AccountsDTO> getOrdersByUserId(Long id);
    ...
    void add_Accounts_by_YSH(Accounts_ychetEntity accountsYchetEntity, int NDS);
  void add_Accounts_by_POD(Accounts_ychetEntity accountsYchetEntity, int NDS);
  void add_Accounts_by_Dov(Accounts_ychetEntity accountsYchetEntity, int NDS);
